    ...
    <section className="uiuxbreak:pt-[4rem] mobile-s:pt-[3rem] relative flex flex-col items-center w-full bg-black text-white overflow-hidden" id='home'>
      <div className="max-w-7xl mx-auto mobile:px-12 mobile-s:px-5  w-full mobile:py-[3.5rem] py-[3rem]">
        <div className="flex flex-col items-center tablet:text-center text-left">
          <span className="mobile:text-[14px] text-[13px] font-[400] text-[#FFD700] mb-1 mobile-s:w-[100%] z-10">TRUSTED DESIGN AND DEVELOPMENT AGENCY</span>
          
          <h1 className="uiuxbreak:text-h1 tablet:text-mh1 mobile:text-sh1 mobile-s:text-xsh1 mb-6 uiuxbreak:w-[720px] tablet:w-[525px] mobile:w-[100%] mobile-s:w-auto relative z-10">
          ...
          <p className="mobile:text-lg mobile-s:text-[16px] text-gray-300 max-w-2xl mb-8 z-10">
